...
public class wineClassifier {
	public static wine [] search;//data set from file
		
	public static void main(String[] args) throws FileNotFoundException {
		String [] a = new String[12];//strings of wines attributes
		a[0] = "color";//color, categorical attribute, should be first
		a[1] = "fixed acidity";
	...
	//find a wine from data set that is similar to passed wine
	//wine is similar if at least 7 attributes are close, including color 
